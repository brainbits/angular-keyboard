module.exports = ['$keyboardProvider', function($keyboardProvider) {
    ...
    for (var i = 65; i <= 90; i += 1) {
        $keyboardProvider.addKeyMapping(i, String.fromCharCode(i + 32));
        $keyboardProvider.addMacro('shift + ' + String.fromCharCode(i + 32) + ', capslock + ' + String.fromCharCode(i + 32), [String.fromCharCode(i)]);
    }
